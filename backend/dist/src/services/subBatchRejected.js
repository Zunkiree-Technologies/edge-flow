...
exports.getRejectedBySubBatch = exports.getAllRejectedSubBatches = exports.createRejectedSubBatch = exports.DepartmentStage = void 0;
...
const createRejectedSubBatch = async (data) => {
...
exports.createRejectedSubBatch = createRejectedSubBatch;
// ✅ Fetch all rejected sub-batches with related data
const getAllRejectedSubBatches = async () => {
    return await db_1.default.sub_batch_rejected.findMany({
        include: {
            sub_batch: true,
...
exports.getAllRejectedSubBatches = getAllRejectedSubBatches;
// ✅ Fetch rejected sub-batches by Sub-Batch ID
const getRejectedBySubBatch = async (sub_batch_id) => {
    return await db_1.default.sub_batch_rejected.findMany({
        where: { sub_batch_id },
        include: {
            sub_batch: true,
...
exports.getRejectedBySubBatch = getRejectedBySubBatch;
