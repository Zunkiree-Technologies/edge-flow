...
const WorkerPage = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        wageTypeDropdownRef.current &&
        !wageTypeDropdownRef.current.contains(event.target as Node)
      ) {
      ...
      <div className="mb-4 flex items-center gap-3 flex-wrap">
          ...
          options={[
            {
              value: "all",
              label: "All Wage Types",
              description: "Show workers with any wage type",
            },
        ...
        <FilterDropdown
          ...
          options={[
            ...
            {
              value: "wage_rate-desc",
              label: "Wage Rate (High to Low)",
              description: "Highest wage rates first",
            },
            {
              value: "wage_rate-asc",
              label: "Wage Rate (Low to High)",
              description: "Lowest wage rates first",
            },
          ]}
        />
      ...
      {isDrawerOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className="ml-auto w-full max-w-xl bg-white shadow-lg p-4 relative h-screen overflow-y-auto">
            ...
            {editingWorker && (
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-900 mb-1.5">Worker ID</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="relative" ref={wageTypeDropdownRef}>
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-4 h-4 text-gray-400 transition-transform ${showWageTypeDropdown ? "rotate-180" : ""}`}
                  />
                </button>
                  ...
                  <div className="absolute top-full left-0 mt-1 w-full bg-white rounded-lg shadow-lg border border-gray-200 z-50 overflow-hidden">
                    {[
                      ...
                      >
                        <div
                          className={`mt-0.5 w-4 h-4 rounded-full border-2 flex items-center justify-center flex-shrink-0 ${
                            formData.wage_type === option.value
                        ...
                        <div className="flex-1 min-w-0">
                          <div
                            className={`text-sm font-medium ${formData.wage_type === option.value ? "text-[#2272B4]" : "text-gray-900"}`}
                          >
                            {option.label}
                          </div>
