            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <div className="bg-white rounded-lg shadow-xl w-[95vw] max-w-[1400px] max-h-[95vh] overflow-hidden relative flex flex-col">
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-gray-300 bg-white">
                        <h3 className="text-lg font-bold text-red-600">Rejected Batch - Task Details</h3>
                    ...
                    <div className="px-6 py-4 bg-red-100 border-b-2 border-red-500">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-red-800 mt-1">
                                    This batch was rejected from <strong>{taskData.sent_from_department}</strong>
                                </p>
                                {taskData.rejection_reason && (
                                    <div className="mt-2 p-3 bg-white rounded-lg border-l-4 border-red-600">
                                        <p className="text-sm font-semibold text-red-900">Rejection Reason:</p>
                                        <p className="text-sm text-gray-800 mt-1">{taskData.rejection_reason}</p>
                                    </div>
                                )}
                            </div>
                            {taskData.rejected_quantity && (
                                <div className="px-4 py-2 rounded-lg font-bold text-xl bg-red-600 text-white">
                                    {taskData.rejected_quantity.toLocaleString()} pcs
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="bg-red-50 border-2 border-red-300 rounded-lg p-6 mb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="text-gray-900 bg-white p-2 rounded border border-red-300">
                                        {new Date(taskData.rejection_date).toLocaleDateString('en-US')}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-red-600 font-bold text-xl bg-white p-2 rounded border border-red-300">
                                        {taskData.rejected_quantity.toLocaleString()} pieces
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="text-gray-900 bg-white p-2 rounded border border-red-300 min-h-[42px]">
                                        {taskData.rejection_reason || '-'}
                                    </div>
                                </div>
                            </div>
